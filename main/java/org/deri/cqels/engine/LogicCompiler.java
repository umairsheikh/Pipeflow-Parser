...
public class LogicCompiler {
	...
	public RoutingPolicyBase policy;
	 ...
	 */
    public boolean fixedFilterPosition = false;
    ...
    public VarExprList exprs;    	 // Assignments to be done.
    public List<Var> vars;      	// projection variables
    public VarExprList projectVars; 
    public OpRouter root;
	public OpRouter compileModifiers(Query query, ThroughRouter through) {
	    ...
	    */
        ...
        this.projectVars = query.getProject();
       // System.out.println("projectVars   "+projectVars);
        
        this.exprs = new VarExprList();     // Assignments to be done.
        this.vars = new ArrayList<Var>();     // projection variables
        ...
        if (! projectVars.isEmpty() && ! query.isQueryResultStar()) {
            ...
            for (Var v : query.getProject().getVars()) 
            {
                ...
                // Include in project
                vars.add(v) ;
              //  System.out.println("expressions to be done: "+v);
            }
           // System.out.println("assignments from select "+vars);
        }
    ...
    protected Op compileElementOptional(ElementOptional eltOpt, Op current) 
    {
    	...
    	System.out.println("leftjoin "+current);
        return current;
    }
