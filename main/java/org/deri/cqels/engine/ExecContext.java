...
public class ExecContext {
	...
	public com.hp.hpl.jena.sparql.syntax.ElementGroup joinGraph=null; 
	public HeuristicRoutingPolicy newHeuristicRoutingPolicy;
	
	
	public Properties config;
	public HashMap<String, Object> hashMap;
	public HashMap<Integer,OpRouter> routers;
	public DatasetGraphTDB dataset;
	public NodeTable  dictionary;
	public Location location;
	public Environment env;
	public ExecutionContext arqExCtx;
	
	public ArrayList<ElementFilter> filters; //= new ArrayList<ElementFilter>();
	public ArrayList<OpStream> streamOps;   //= new ArrayList<OpStream>();
...
//											  FileFactory.createObjectFileMem(path));
	...
	public ExecContext(String path, boolean cleanDataset, boolean logicplan) 
	{
		this.hashMap = new HashMap<String, Object>();
		//combine cache and disk-based dictionary
//		this.dictionary = new NodeTableNative(IndexBuilder.mem().newIndex(FileSet.mem(), 
...
//											  FileFactory.createObjectFileMem(path));
		...
		newHeuristicRoutingPolicy = new HeuristicRoutingPolicy(this);
		filters = newHeuristicRoutingPolicy._filters;
		streamOps = newHeuristicRoutingPolicy._streamOps;
	}
	...
	public ContinuousSelect registerSelect(String queryStr)
	{
	     ...
	     this.joinGraph= parser.extractedGraphPatter;
